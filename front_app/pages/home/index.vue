  ...
  <div class="flex items-center justify-center bg-slate-100">
    <div class="w-full max-w-sm rounded-lg bg-white p-8 shadow-lg">
      <div class="flex justify-center">
        <img class="h-24 w-24 rounded-full object-cover" src="/public/avatar.png" alt="User Avatar">
      </div>
      ...
      <button class="mt-6 w-full rounded-lg bg-sky-500 px-4 py-2 font-semibold text-white hover:bg-sky-600">
        Follow
      </button>
    </div>
  </div>
